...
export default function Performance() {
  ...
  const fetchReviews = async () => {
    try {
      const res = await axios.get("https://hr-management-backend-w6w4.vercel.app/api/performance");
      setReviews(res.data);
    } catch (err) {
  ...
  try {
    if (editId) {
      // ✅ UPDATE
      await axios.put(`https://hr-management-backend-w6w4.vercel.app/api/performance/${editId}`, {
        ...formData,
        rating: Number(formData.rating),
      });
    } else {
      // ✅ CREATE
      await axios.post("https://hr-management-backend-w6w4.vercel.app/api/performance", {
        ...formData,
        rating: Number(formData.rating),
      });
    }
  ...
  try {
    await axios.patch(`https://hr-management-backend-w6w4.vercel.app/api/performance/${id}`, {
      status: "Completed",
    });
    fetchReviews();
  } catch (err) {
...
const deleteReview = async (id) => {
  ...
  try {
    ...
    await axios.delete(`https://hr-management-backend-w6w4.vercel.app/api/performance/${id}`);
    fetchReviews();
  } catch (err) {

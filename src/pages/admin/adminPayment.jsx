...
export default function AdminPayments() {
  ...
  const fetchPayments = async () => {
    const res = await axios.get("https://hr-management-h9l2.vercel.app/api/payments");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        // 🔁 UPDATE
        await axios.put(
          `https://hr-management-h9l2.vercel.app/api/payments/${editId}`,
          { ...formData, amount: Number(formData.amount) }
        );
      } else {
        // ➕ CREATE
        await axios.post("https://hr-management-h9l2.vercel.app/api/payments", {
          ...formData,

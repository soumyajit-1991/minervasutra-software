...
//     const res = await axios.get("https://hr-management-h9l2.vercel.app/api/clients");
//     setClients(res.data);
//   };
...
//   //   await axios.post("https://hr-management-h9l2.vercel.app/api/clients", {
//   //     ...formData,
...
//     // UPDATE
//     await axios.put(
//       `https://hr-management-h9l2.vercel.app/api/clients/${editingClient}`,
//       payload
//     );
//   } else {
//     // CREATE
//     await axios.post(
//       "https://hr-management-h9l2.vercel.app/api/clients",
//       payload
//     );
//   }
...
function Clients() {
 ...
 const handleDelete = async (id) => {
  try {
    ...
    await axios.delete(
      `https://hr-management-h9l2.vercel.app/api/clients/${id}`
    );

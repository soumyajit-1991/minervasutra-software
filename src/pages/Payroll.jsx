...
export default function Payroll() {
  ...
  const fetchPayroll = async () => {
    try {
      const res = await axios.get("https://hr-management-backend-w6w4.vercel.app/api/payroll");
      setRecords(res.data);
    } catch (err) {
  ...
  const handleSubmit = async () => {
    try {
      await axios.post("https://hr-management-backend-w6w4.vercel.app/api/payroll", {
        ...formData,

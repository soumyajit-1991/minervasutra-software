...
import { fetchOfferById, updateOffer } from "../api/offerService";
...
export default function EditOffer() {
      ...
      if (loading) return <div className="p-6 ml-64 mt-16">Loading...</div>;
                  ...
                  <div className={`p-6 rounded-lg shadow-md ${darkMode ? "bg-gray-800" : "bg-white"}`}>
                        <form onSubmit={handleSubmit} className="space-y-4">
                              ...
                              <div className="flex justify-end gap-3 mt-6">
                                    ...
                                    <button type="submit" className="px-4 py-2 rounded bg-blue-600 text-white hover:bg-blue-700 flex items-center gap-2 transition"><Save size={18} /> Update Offer</button>
                              </div>
                        </form>
                  </div>
            </div>

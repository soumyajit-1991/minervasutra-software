...
```env
VITE_API_URL=https://hr-management-r6bh.vercel.app
```
...
- **Backend API**: https://hr-management-r6bh.vercel.app
- **API Health Check**: https://hr-management-r6bh.vercel.app/api/health
